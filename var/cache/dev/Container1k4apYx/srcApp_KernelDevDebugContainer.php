...
class srcApp_KernelDevDebugContainer extends Container
{
     ...
     */
    protected function getForumControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/ForumController.php';

        $this->services['App\\Controller\\ForumController'] = $instance = new \App\Controller\ForumController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'session' => '?',
            'twig' => '?',
        ]))->withContext('App\\Controller\\ForumController', $this));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nYznSX1TOb', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GvWLpsFivb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\ForumRepository' => ['privates', 'App\\Repository\\ForumRepository', 'getForumRepositoryService', false],
        ], [
    ...
    /**
     * Gets the private '.service_locator.0LOIj1B' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_0LOIj1BService()
    {
        return $this->privates['.service_locator.0LOIj1B'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ForumController::deleteForum' => ['privates', '.service_locator.lIlBmVV', 'get_ServiceLocator_LIlBmVVService', false],
            'App\\Controller\\ForumController::getForumById' => ['privates', '.service_locator.lIlBmVV', 'get_ServiceLocator_LIlBmVVService', false],
            'App\\Controller\\ForumController::index' => ['privates', '.service_locator.lIlBmVV', 'get_ServiceLocator_LIlBmVVService', false],
            'App\\Controller\\ForumController::updateForum' => ['privates', '.service_locator.lIlBmVV', 'get_ServiceLocator_LIlBmVVService', false],
            'App\\Controller\\ForumController:deleteForum' => ['privates', '.service_locator.lIlBmVV', 'get_ServiceLocator_LIlBmVVService', false],
            'App\\Controller\\ForumController:getForumById' => ['privates', '.service_locator.lIlBmVV', 'get_ServiceLocator_LIlBmVVService', false],
            'App\\Controller\\ForumController:index' => ['privates', '.service_locator.lIlBmVV', 'get_ServiceLocator_LIlBmVVService', false],
            'App\\Controller\\ForumController:updateForum' => ['privates', '.service_locator.lIlBmVV', 'get_ServiceLocator_LIlBmVVService', false],
            ...
            'App\\Controller\\ForumController::getForumById' => '?',
    ...
    /**
     * Gets the private '.service_locator.lIlBmVV' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_LIlBmVVService()
    {
        return $this->privates['.service_locator.lIlBmVV'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'forumRepository' => ['privates', 'App\\Repository\\ForumRepository', 'getForumRepositoryService', false],
        ], [
     ...
     */
    protected function getForumRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\ForumRepository'] = new \App\Repository\ForumRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mfqntFyWlk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u8n6-Q2Zfu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CxYgW0VuLL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qk64oYXTEo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ScgNWbVPzl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.0LOIj1B'] ?? $this->get_ServiceLocator_0LOIj1BService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
